...
import { toBinaryFields, fillBinaryFields } from '../src/binary/fill-binary-fields';
...
describe('CardData', () => {
  ...
  describe('isDeclarable', () => {
    ...
    it('should evaluate OPCODE_ISTYPE correctly', () => {
      ...
      card.code = 12345;
      card.alias = 0;
      card.type = OcgcoreCommonConstants.TYPE_MONSTER | OcgcoreCommonConstants.TYPE_EFFECT;
    ...
    it('should reject tokens with alias', () => {
      ...
      card.type = OcgcoreCommonConstants.TYPE_MONSTER | OcgcoreCommonConstants.TYPE_TOKEN;
